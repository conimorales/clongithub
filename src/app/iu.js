class UI {
    ...
    showProfile(user) {
        ...
        <div class = "card mt-2 animate__animated animate__bounceIn">
            <img src="${user.avatar_url}" class="card-img-top"/>
            <div class = "card-body">
                <h3 class="card-title">${user.name} / ${user.login} </h3>

                <a href="${user.html_url}"
                class="btn btn-block btn-dark" target="__blank"> View profile </a>
    ...
    showRepositories(repositories) {
        ...
        repositories.forEach(repo => {
            template += `
                <div class= "card card-body mt-2 animated__bounceInUp">
                    <div class="row">
                        <div class="col md 6">
